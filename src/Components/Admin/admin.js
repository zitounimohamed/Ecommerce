...
import admin from '../img/avatar5.png'
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="/" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src={admin}/>
              </a>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="progress-group">
                        ...
                        <div class="progress progress-sm">
                          <div class="progress-bar bg-primar" style={{width: 80}}></div>
                        </div>
                      </div>
          ...
          <div class="row" style={{marginTop :"22px"}}>
            ...
            <div class="col-md-8">
              ...
              <div class="card">
                ...
                <center><a href="/commande" class="uppercase">Afficher toutes les commandes</a></center> 
                </div>
             </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card">
                  ...
                  {this.state.piece.map(piece =>(
                    <li class="item">
                      ...
                      <div class=" col-md-8 product-info">
                        <div class="product-title">{piece.nom}
                          <span class="badge badge-warning float-right" style={{marginRight:'-14%'}}>{piece.prix} DT</span></div>
                ...
                <div class="card-footer text-center">
                  <a href="/product" class="uppercase">Afficher tous les produits</a>
                </div>
