...
class ajoutTrans extends Component {
    constructor(props){
        super(props);
        this.state={
            nom : null,
    ...
    handelSubmit = async (event) => {
        ...
        let url = "http://localhost:5000/users/newTrans"
        const data = {
            nom : this.state.nom,
    ...
    console.log("data", data);
        await axios.post(url,data).then((response)=>{
            if(response.status === 200 && response.data!= null){
              ...
              //  window.location.href = "/updatecompte"
            }
    ...
    render() {
        return (
         ...
         { /************************************************************** */}
            <div>
            <br/><br/><br/><br/>
            <figure className='figadmin'><h1>Ajouter un transporteur</h1></figure>
            <div class='container '>
